...
def save_callback(msg):
    ...
    time_str = img_time.strftime("%Y-%m-%d_%H-%M-%S")
    img_filename = 'manual_image_%s.png' % (time_str)
...
if not os.path.exists("Manual_Save"):
    os.mkdir("Manual_Save")
os.chdir("Manual_Save")
